    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card card-secondary">
                ...
                @endif
                <form action="{{ route('ukuran.store', $produk->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="inputWarna">Ukuran Produk</label>
                            <div class="col-sm-10 col-md-6 col-lg-4">
                                {!! Form::text('name', null, ['class' => 'form-control', 'id' => 'inputWarna', 'placeholder' => 'Masukkan Ukuran Produk']) !!}
        ...
        <div class="col-sm-12">
          ...
          <? } ?> --}}
                    <table class="table table-bordered table-striped" id="DataTable">
                        ...
                        <tbody>
                            @foreach ($ukurans as $ukuranProduk)
                                <tr>
                                    <td>{{ ++$i }}</td>
                                    <td>
                                        {{-- <img src="{{ asset('storage/produk-image/' . $ukuranProduk->gambar) }}"
                                            alt="{{ $ukuranProduk->gambar }}" class="img-thumbnail" width="100"> --}}
                                        {{ $ukuranProduk->name }}

                                    </td>
                                    <td>
                                        <form action="{{ route('ukuran.destroy', [$produk, $ukuranProduk->id]) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
